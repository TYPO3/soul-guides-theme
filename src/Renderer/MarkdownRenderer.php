 ...
 * and every reference inside it resolves to the Markdown of the page it
 * points at. That is what makes the twin a site of its own rather than a file
 * beside a page. Nothing to override: the base walks the documents and hands
 * each to the node renderers registered for the requested format.
 */
