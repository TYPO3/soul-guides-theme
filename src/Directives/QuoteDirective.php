 ...
 * decides on its own. `sds-quote` needs it, as a quotation with no source in a
 * product's own text is the product quoting itself for emphasis. A necessary
 * thing said as an option is a thing an author leaves out. The sentence goes
 * between the tags instead. Out of a document it carries links and emphasis,
 * which an attribute cannot hold.
 *
 * A block quote is the spelling to reach for, and it is not available. The
 * parser resolves an indented block with an attribution line into a
