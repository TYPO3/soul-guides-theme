 ...
 *
 * Every block in it is a column, which is what `half` is for: a run of
 * paragraphs is a run of columns until something says where one of them ends.
 * No width and no count — the halves fold under each other by their own
 * minimum, the way every other set in this system reflows.
 *
...
final class SplitDirective extends SubDirective
{
    ...
    protected function processSub(
        ...
        return (new SplitNode($collectionNode->getChildren()))->withOptions([
